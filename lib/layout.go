...
func InstallYML(softdir string) {
    ...
    install_file.WriteString("- remote_user: root\n  hosts: master\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/0.base/genfile\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/0.base/kernel\n- remote_user: root\n  hosts: master,node,nginx\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/0.base/all\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/8.action/delnode\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/0.base/docker\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/1.cfssl/copycfssl\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/1.cfssl/createssl\n- remote_user: root\n  hosts: etcd\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/2.etcd\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/3.network/etcd_network\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/3.network/flanneld\n- remote_user: root\n  hosts: nginx\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/4.kube-nginx/nginx\n- remote_user: root\n  hosts: master,node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/kubectl\n- remote_user: root\n  hosts: master\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/apiserver\n- remote_user: root\n  hosts: nginx\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/4.kube-nginx/keepalived\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/api-rbac\n- remote_user: root\n  hosts: master\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/controller-manager\n- remote_user: root\n  hosts: master\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/scheduler\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/6.kube-node/kubelet\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/6.kube-node/approve-csr\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/6.kube-node/kube-proxy\n- remote_user: root\n  hosts: master1\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/7.kube-addons\n- remote_user: root\n  hosts: master\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/5.kube-master/admintoken\n- remote_user: root\n  hosts: nginx\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/4.kube-nginx/alter\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/8.action/pushimages\n- remote_user: root\n  hosts: node\n  gather_facts: no\n  roles:\n    - "+softdir+"/sys/9.finish/install\n")
}
