...
func GetClusterAddons(label string, currentDir string, mode string) (string,string,string) {
    ...
    k8sdashboardtoken,err_k8sdashboardip := ReadFile(currentDir+"/data/output"+subProcessDir+"/cert/dashboard_login_token.txt")
    if err_registryip == nil && err_k8sdashboardip == nil && err_k8sdashboardip == nil {
