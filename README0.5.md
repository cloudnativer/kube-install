...
<br>
The parameters about kube-install can be viewed using the `kube-install help` command. You can also <a href="docs/parameters0.5.md">see more detailed parameter introduction here</a>.<br>
<br>
<br>
<br>
