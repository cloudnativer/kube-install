...
```
# kube-install -opt delnode -node "192.168.1.13,192.168.1.15" -label "192168001011"
```
...
```
# kube-install -opt delmaster -master "192.168.1.13" -label "192168001011"
```
...
```
# kube-install -opt rebuildmaster -rebuildmaster "192.168.1.13" -k8sver "1.22" -ostype "centos7" -label "192168001011"
```
...
```
# kube-install -opt uninstall -master "192.168.1.11,192.168.1.12,192.168.1.13" -node "192.168.1.11,192.168.1.12,192.168.1.13,192.168.1.14" -label "192168001011"
```
