...
<tr><td> kube-install v0.5.* </td><td>kubernetes v1.21.* , Install kubernetes v1.20.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.* </td><td>CentOS 7/RHEL 7</td></tr>
<tr><td> kube-install v0.4.* </td><td>kubernetes v1.21.* , Install kubernetes v1.20.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.*</td><td>CentOS 7/RHEL 7</td></tr>
