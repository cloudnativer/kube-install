...
<table>
<tr><td><b>kube-install Version</b></td><td><b>Supported kubernetes versions</b></td><td><b>Supported OS</b></td></tr>
<tr><td> kube-install v0.6.* </td><td> kubernetes v1.22.* ，kubernetes v1.21.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.*</td><td>CentOS 7/RHEL 7/CentOS 8/RHEL 8/SUSE15</td></tr>
<tr><td> kube-install v0.5.* </td><td> Install kubernetes v1.21.* , Install kubernetes v1.20.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.* </td><td>CentOS 7/RHEL 7</td></tr>
<tr><td> kube-install v0.4.* </td><td> Install kubernetes v1.21.* , Install kubernetes v1.20.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.*</td><td>CentOS 7/RHEL 7</td></tr>
<tr><td> kube-install v0.3.* , Install kubernetes v1.20.* ，kubernetes v1.20.* ，kubernetes v1.19.* ，kubernetes v1.18.* ，kubernetes v1.17.* ，kubernetes v1.16.* ，kubernetes v1.15.* ，kubernetes v1.14.*</td><td> Install kubernetes v1.18.* </td><td>CentOS 7</td></tr>
<tr><td> kube-install v0.2.* </td><td> Install kubernetes v1.14.* </td><td>CentOS 7</td></tr>
<tr><td> kube-install v0.1.* </td><td> Install kubernetes v1.14.* </td><td>CentOS 7</td></tr>
</table>
<br>
...
For example, we are now installing kubernetes v1.21, and we have downloaded the `kube-install-for-k8s1.21-v0.6.1.tgz` package.<br>


```
# cd /root/
# wget https://github.com/cloudnativer/kube-install/releases/download/v0.6.1/kube-install-for-k8s1.21-v0.6.1.tgz
# tar -zxvf kube-install-for-k8s1.21-v0.6.1.tgz
