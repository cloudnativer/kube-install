...
<br>
The parameters about kube-install can be viewed using the "kube-install -opt help" command. <a href="docs/parameters0.2.md">You can also see more detailed parameter introduction here.</a><br>
<br>
<br>
<br>
