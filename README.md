...
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.14-v0.4.0.tgz</td><td> Install kubernetes v1.14.* </td></tr>
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.15-v0.4.0.tgz</td><td> Install kubernetes v1.15.* </td></tr>
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.16-v0.4.0.tgz</td><td> Install kubernetes v1.16.* </td></tr>
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.17-v0.4.0.tgz</td><td> Install kubernetes v1.17.* </td></tr>
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.18-v0.4.0.tgz</td><td> Install kubernetes v1.18.* </td></tr>
<tr><td> kube-install v0.4.* </td><td> kube-install-for-k8s1.19-v0.4.0.tgz</td><td> Install kubernetes v1.19.* </td></tr>
</table>
<br>
